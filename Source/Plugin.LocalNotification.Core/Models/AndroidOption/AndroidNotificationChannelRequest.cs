...
public class AndroidNotificationChannelRequest
{
    ...
    public string Id
    {
        get => string.IsNullOrWhiteSpace(field) ? AndroidOptions.DefaultChannelId : field;
        set => field = string.IsNullOrWhiteSpace(value) ? AndroidOptions.DefaultChannelId : value;
    } = AndroidOptions.DefaultChannelId;
    ...
    public string Name
    {
        get => string.IsNullOrWhiteSpace(field) ? AndroidOptions.DefaultChannelName : field;
        set => field = string.IsNullOrWhiteSpace(value) ? AndroidOptions.DefaultChannelName : value;
    } = AndroidOptions.DefaultChannelName;
